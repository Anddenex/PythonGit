...
describe('Sidebar Tests', () => {
    ...
    it('Open Trading Network coin page assertion', () => {
        ...
        cy.get('.offset-3 > .container > .row > :nth-child(2)')
            .should('have.text', "Open Trading Network")
    })
