...
describe('Sidebar Tests', () => {
    ...
    it('Time New Bank coin page assertion', () => {
        ...
        cy.get('.offset-3 > .container > .row > :nth-child(2)')
            .should('have.text', "Time New Bank")
    })
    ...
    it('Streamr DATAcoin coin page assertion', () => {
        ...
        cy.get('.offset-3 > .container > .row > :nth-child(2)')
            .should('have.text', "Streamr DATAcoin")
    })
    ...
    it('Quantum Resistant Ledger coin page assertion', () => {
        ...
        cy.get('.offset-3 > .container > .row > :nth-child(2)')
            .should('have.text', "Quantum Resistant Ledger")
    })
})