...
module.exports = defineConfig({
  env: {
    ...
    prod_give_phrase:
      'pudding, nut, into, draw, give, boost, lens, token, orphan, scout, error, enjoy',
    stage_give_phrase:
      'parrot, steak, buyer, slot, zebra, very, dance, neglect, broccoli, prevent, envelope, snow',
    stage_green_phrase:
      'lamp, initial, river, eternal, average, fiber, waste, spoon, garbage, tennis, uncle, gallery',
