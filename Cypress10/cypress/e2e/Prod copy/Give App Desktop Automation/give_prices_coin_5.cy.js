...
describe('Coin Tests', () => {
    ...
    it('Experience Points coin page assertion', () => {
        ...
        cy.get('.offset-3 > .container > .row > :nth-child(2)')
            .should('have.text', "Experience Points")
    })
