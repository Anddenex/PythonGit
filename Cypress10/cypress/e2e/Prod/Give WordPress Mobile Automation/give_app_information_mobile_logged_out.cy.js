...
describe('Login', () => {
    ...
    it('Document Test - iPhone-8-portrait', () => {
        ...
        cy.get('[class="nectar-button jumbo regular accent-color  regular-button"]').should(($button) => {
            ...
            expect($button.eq(1), 'Sign Up Free button')
                .to.contain('Sign Up Free')
                .to.have.attr('style', "margin-right: 10px; margin-left: 10px; visibility: visible;")
                .to.have.attr('href', "/lets-give/")
                .to.have.attr('data-hover-text-color-override', "#fff")
        }) 
        cy.get('h4').should('have.length.gte', 5)
        cy.get('h4').should(($node_title) => {
            ...
            expect($node_title.eq(2), 'Third title text')
                .to.contain("$25")
            expect($node_title.eq(3), 'Second title text')
                .to.contain("Smart Node")
            expect($node_title.eq(4), 'Third title text')
                .to.contain("Log in to see live price.")
        }) 
        cy.get('h5').should('have.length.gte', 4)
        ...
        cy.get('p').should('have.length.gte', 13)
